...
RAG_FULL_CONTEXT_MAX_CHARS = PersistentConfig(
    ...
    int(os.environ.get('RAG_FULL_CONTEXT_MAX_CHARS', '100000')),
)
...
RAG_FILE_MAX_CHARS = PersistentConfig(
    'RAG_FILE_MAX_CHARS',
    'rag.file.max_chars',
    (int(os.environ.get('RAG_FILE_MAX_CHARS')) if os.environ.get('RAG_FILE_MAX_CHARS') else None),
)
